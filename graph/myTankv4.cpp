...
class bldTank{
public:
   bldTank(osg::ref_ptr<osg::MatrixTransform> terrain){
       ...
       /*初始化坦克位置*/
       double tankXPosition = 0.0;
       double tankYPosition = 0.0;
       ...
       terrain->accept(findTankElevationVisitor);
       ...
       tanktrans->setMatrix(osg::Matrix::translate(terrainHeight));
       guntrans->setMatrix(osg::Matrix::translate(terrainHeight));
       turrettrans->setMatrix(osg::Matrix::translate(terrainHeight));
...
public:
   ...
   dataType(bldTank *n,nodeMoveState *tids,osg::ref_ptr<osg::MatrixTransform> terrain){
       keyboard=tids;
       myTank=n;
       dirt=terrain;
       pos.set(0.0,0.0,getHight(0,0));
...
int main(){
   ...
   dataType *transData=new dataType(mytank,tids,dirt);

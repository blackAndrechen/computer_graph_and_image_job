   ...
   virtual bool handle(const osgGA::GUIEventAdapter& ea,osgGA::GUIActionAdapter& aa) {
       ...
       switch (ea.getEventType()) {
           case osgGA::GUIEventAdapter::KEYDOWN: {//各种按键响应
               if (ea.getKey() == 'w' or ea.getKey() =='W') {
                   nms->up=true;
               }
               else if (ea.getKey() == 's' or ea.getKey() =='S') {
                   nms->down=true;
               }
               if (ea.getKey() == 'a' or ea.getKey() =='A') {
                   nms->left=true;
               }
               else if (ea.getKey() == 'd' or ea.getKey() =='D') {
                   nms->right=true;
               }
               if (ea.getKey() == 'k' or ea.getKey() =='K') {
                   nms->gunup=true;
               }
               else if (ea.getKey() == 'l' or ea.getKey() =='L') {
                   nms->gundown=true;
               }
               else if (ea.getKey() == 'h' or ea.getKey() =='H') {
                   nms->turretl=true;
               }
               else if (ea.getKey() == 'j' or ea.getKey() =='J') {
                   nms->turretr=true;
               }
               if (ea.getKey() == 0x20) {
                   if(nms->bullet==false){
...
osg::Camera* createHUD()
{
   ...
   camera->setAllowEventFocus(false);
   {
       ...
       osg::Vec3 position(0.0f,180.0f,0.0f);
       osg::Vec3 delta(0.0f,-40.0f,0.0f);
       {
           ...
           text->setText(" w/s   forward or backward");
       ...
       }
       {
           ...
           text->setFont(timesFont);
           text->setPosition(position);
           text->setText(" a/d   left or right");
...

       {
           ...
           text->setFont(timesFont);
           text->setPosition(position);
           text->setText(" h/j   rotating turret");
       ...
       }
       {
           ...
           text->setFont(timesFont);
           text->setPosition(position);
           text->setText(" k/l   adjust gun angle");
       ...
       }
       {
           ...
           text->setFont(timesFont);
           text->setPosition(position);
           text->setText("space  launch bomb");
       ...
       }
       {
           ...
           colors->push_back(osg::Vec4(1.0f,1.0,0.8f,0.1f));
...
int main(){
   osgViewer::CompositeViewer viewerAll;
